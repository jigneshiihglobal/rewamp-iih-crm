            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header p-1 invoice-note-lbl">
                        <h4 class="card-title"> {{ $view_config['title'] ?? 'Create' }} One-off Invoice</h4>
                        <div>
                        ...
                        <form class="form repeater" id="invoice_form">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="invoice_number" class="form-control form-control-sm"
                                            ...
                                            value="{{ old('invoice_number', isset($invoice) && isset($invoice->invoice_number) && Route::is('invoices.edit') ? $invoice->invoice_number : $invoice_number) }}" />
                                ...
                                <div class="col-12" id="invoiceItemsTable">
                                    @if (Route::is('invoices.edit') && $invoice->payment_status != 'unpaid')
                                                        ...
                                                        <tr data-repeater-item>
                                                            <td class="align-top ps-0" style="width: 34%">
                                                                ...
                                                                <input type="hidden" name="id"
                                                                    value="{{ Route::is('invoices.edit') ? $invoice_item->id : '' }}">
                                                            </td>
        ...
        $(document).ready(function() {
            ...
            var invoiceForm = $('#invoice_form').validate({
                ...
                submitHandler: function(form, event) {
                    ...
                    let url = route('invoices.one-off.store');
                    let method = 'POST';
                    if (route().current('invoices.edit')) {
                        url = route('invoices.update', invoice?.encrypted_id);
                        method = 'PUT';
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            window.location.href = route().current('invoices.edit') ?
                                "{{ url()->previous() }}" :
