...
<div class="modal fade" id="invoiceNotesModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered notes-modal">
        <div class="modal-content">
            ...
            <div class="modal-body bg-light">
                <form class="form form-horizontal" id="invoiceNoteForm" method="POST">
                    @csrf
                    <input type="hidden" name="invoices_id" id="invoices_id">
                    <input type="hidden" name="invoices_note_id" id="invoices_note_id">
                ...
                <hr>
                <h3>Notes history</h3>
                <div id="invoices_notes_list"></div>
            </div>
        </div>
    </div>
</div>
