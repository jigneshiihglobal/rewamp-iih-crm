...
{{--            </div>--}}
            <div class="col-12 d-flex justify-content-end align-items-start">
                <div id="expense_filters_wrapper" class="align-items-center collapse mx-0">
                    <div class="col-xxl-2 col-lg-3 col-sm-4 form-group">
                        <div class="form-check form-check-inline me-1 mt-1 mt-sm-0">
                            <input type="checkbox" id="showDeletedCheck" class="form-check-input me-50" value="1" />
                            <label class="form-check-label" for="showDeletedCheck" style="width: 100px;">Show Deleted</label>
                        </div>
                    </div>
                </div>
                <a data-bs-toggle="collapse" href="#expense_filters_wrapper" role="button" aria-expanded="false"
                    aria-controls="expense_filters_wrapper" style="margin-bottom: 15px;">
                    Advanced Search
                </a>
            </div>
            <div class="col-sm-4 col-lg-3 col-xl-2 col-xxl-2 pe-md-1 ps-md-0">
                <div class="card mt-1 mt-xl-0 mb-0 last-month-stats bg-light-warning">
                    ...
                    <div class="card-body row p-1 pt-0">
                        ...
                        <span class="nowrap-white-space padding-left-6px">
                            ...
                            <span class="ms-auto nowrap-white-space padding-right-6px" id="last_year_mar_exp">
                            £0
                        </span>
                        </div>
                    </div>
            ...
            <div class="col-sm-4 col-lg-3 col-xl-2 col-xxl-2 ps-md-0 ms-md-0">
                <div class="card mt-1 mt-xl-0 mb-0 this-month-stats bg-light-success">
                    <div class="card-header p-1 pb-0 padding-left-6px">
                        <h6 class="text-reset">This year</h6>
                    </div>
                    <div class="card-body row p-1 pt-0">
                        <div class="col-12 d-flex justify-content-between">
                        <span class="nowrap-white-space padding-left-6px">
                            ...
                            <span class="ms-auto nowrap-white-space padding-right-6px" id="this_year_mar_exp">
                            £0
                        </span>
                        </div>
                    </div>
                ...
                <div class="card mt-1 mt-xl-0 mb-0 last-month-stats bg-light-warning">
                    ...
                    <div class="card-body row p-1 pt-0">
                        ...
                        <span class="nowrap-white-space padding-left-6px">
                            ...
                            <span class="ms-auto nowrap-white-space padding-right-6px" id="last_month_mar_exp">
                            £0
                        </span>
                        </div>
                    </div>
                ...
                <div class="card mt-1 mt-xl-0 mb-0 this-month-stats bg-light-success">
                    ...
                    <div class="card-body row p-1 pt-0">
                        ...
                        <span class="nowrap-white-space padding-left-6px">
                            ...
                            <span class="ms-auto nowrap-white-space padding-right-6px" id="this_month_mar_exp">
                            £0
                        </span>
                        </div>
                    </div>
    ...
    <section id="expenses_list">
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <table class="table" id="marketing_expenses_table">
    ...
    @include('marketing_expenses.marketing_expenses_notes.modal')
@endsection
...
@section('custom-js')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            const $expensesTable = $expensesList.find('#marketing_expenses_table');
            ...
            const expensesDataTable = $expensesTable.DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'marketing_expense_date',
                        name: 'marketing_expense_date',
                    },
                    {
                        data: "marketing_expense_type.title",
                        name: "marketing_expense_type.title",
                    },
                    {
                        data: null,
                        searchable: false,
                        ...
                        "render": function(data, type, full) {
                            ...
                            let expenseNotesCount = full['marketing_expense_notes_count'];

                            let expenseEditBtn = '<a ' +
                                'href="' + route('marketing.expenses.edit', encId) + '" ' +
                                'title="Edit" ' +
                            ...
                            let expenseShowBtn = '<a ' +
                                'href="' + route('marketing.expenses.show', encId) + '" ' +
                                'title="Show" ' +
                            ...
                            let expenseCopyBtn =
                                ...
                                'title="Copy"' +
                                'href="' +
                                route('marketing.expenses.copy', full['encrypted_id']) + '">' +
                ...
                buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        window.location.href = route('marketing.expenses.create-many');
                    }
                }],
            });
            ...
            $(document).on('click', '.expenseDeleteBtn', function(e) {
                ...
                Swal.fire({
                    title: 'Are you sure you want to delete this marketing expense?',
                    ...
                    if (result.value) {
                        $.ajax({
                            url: route('marketing.expenses.destroy', id),
                            method: 'DELETE',
                            data: {
                                _token: $('meta[name=csrf-token]').attr('content')
                            },
                            success: function(response) {
                                toastr.success(null, "Marketing expense deleted successfully!");
                                redrawExpensesTable();
                            },
            ...
            $(document).on('click', '.expenseRestoreBtn', function(e) {
                let id = $(this).data('id');
                Swal.fire({
                    title: 'Are you sure you want to restore this marketing expense?',
                    text: "You can revert this by deleting marketing expense again!",
                    icon: 'warning',
                    showCancelButton: true,
                    ...
                    if (result.value) {
                        $.ajax({
                            url: route('marketing.expenses.restore', id),
                            method: 'PUT',
                            data : {id:id},
                            headers: {
                            ...
                            success: function(response) {
                                toastr.success(null, "Marketing expense restored successfully!");
                                redrawExpensesTable();
                            },
                            error: function(xhr, status, error) {
                                toastr.error(xhr.responseJSON?.message ?? null, error);
            ...
            $(notesModal).on('show.bs.modal', function(event) {
                ...
                var addExpenseNoteUrl = route("marketing.marketing_expense_notes.store", expense_id);
            ...
            $('#notesModal').on('click', '.editNoteBtn', function(e) {
                ...
                let updateExpenseRoute = route('marketing.marketing_expense_notes.update', [expenseId, expenseNoteId]);
            ...
            $('#notesModal').on('click', '.deleteNoteBtn', function(e) {
                ...
                let expenseId = $(notesModal).find('#expense_id').val();
                Swal.fire({
                    title: 'Are you sure you want to delete this marketing expense note?',
                    ...
                    if (result.value) {
                        $.ajax({
                            url: route('marketing.marketing_expense_notes.destroy', [expenseId,
                                expenseNoteId
                            ]),
                            data: {
                                _token: $('meta[name=csrf-token]').attr('content') ?? '',
                            ...
                            success: function(response) {
                                toastr.success(null,
                                    "Marketing expense note deleted successfully!");
                                fillNotesList();
                                redrawExpensesTable();
                            },
                            error: function(xhr, status, error) {
            ...
            function resetNotesModalToDefault() {
                ...
                $(addNoteForm).attr('action', route('marketing.marketing_expense_notes.store', [expense_id]));
            ...
            function fillNotesList() {
                let expense_id = $(notesModal).find('#expense_id').val();
                var getExpenseNotesUrl = route("marketing.marketing_expense_notes.index", expense_id);
                $.ajax({
            ...
            function buildExpenseNoteHtml(expenseNote) {
                ...
                let editedIndicator = edited ?
                    ...
                    ``;
                let deleteNoteBtn =
                    `<a class="btn btn-icon p-0 me-1 ${expenseNote.can_delete ? 'deleteNoteBtn' : ''}" data-id="${expenseNote.encrypted_id}" href="#" title='Delete' >${feather.icons['trash'].toSvg({ class: 'font-small-4 text-danger' })}</a>`;
            ...
            function updateSalesStatistics() {
                $.ajax({
                    url: route('marketing-rate-currency'),
                    method: 'GET',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name=csrf-token]').attr('content')
                    },
