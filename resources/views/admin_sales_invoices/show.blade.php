                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="d-flex justify-content-between flex-md-row flex-column mt-0">
                            ...
                            <div class="mt-md-0 mt-2 d-flex flex-column invoice-spacing align-items-md-end">
                                ...
                                @php
                                    $isDisabled = in_array($invoice->status, [2,3]);
                                @endphp
                                <div class="payment-buttons  mt-auto">
                                    <a href="{{ $isDisabled ? '#' : route('sales_invoice_create', $invoice->encrypted_id) }}"
                                        class="btn btn-sm btn-outline-primary waves-effect {{ $isDisabled ? 'restricted-btn' : '' }}">
