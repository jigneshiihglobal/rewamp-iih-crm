            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pt-1">
                        <form class="form repeater" id="invoice_form" action="{{ route('sales_invoices.update', $invoice->id) }}" method="POST" data-invoice-id="{{ \App\Helpers\EncryptionHelper::encrypt($invoice->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="invoice_type" id="invoice_type_one_off" value="0"
                                                class="form-check-input" {{ old('invoice_type', $invoice->type) == '0' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input type="radio" name="invoice_type" id="invoice_type_subscription" value="1"
                                                class="form-check-input" {{ old('invoice_type', $invoice->type) == '1' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="invoice_date" class="form-control form-control-sm"
                                            ...
                                            value="{{ old('invoice_date', \Carbon\Carbon::parse($invoice->invoice_date)->format('d-m-Y')) }}"
                                            autocomplete="off"/>
                                        @error('invoice_date')
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="due_date" class="form-control form-control-sm"
                                            ...
                                            value="{{ old('due_date', \Carbon\Carbon::parse($invoice->due_date)->format('d-m-Y')) }}"/>
                                        @error('due_date')
                                ...
                                <div class="col-12 align-items-start pe-2 pe-sm-5">
                                    <div class="float-end">
                                        ...
                                        <button type="submit" class="btn btn-primary me-1" id="invoiceUpdateBtn">Update</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var invoiceForm = $('#invoice_form').validate({
                ...
                messages: {
                    invoice_type: {
                        required: "Please select an invoice type"
                    },
                    currency_id: {
                ...
                submitHandler: function(form, event) {
                    ...
                    $('#invoiceUpdateBtn').prop('disabled', true);
                    $(form).block({
                    ...
                    let url = route('sales_invoices.update', invoiceId);
                        ...
                        error: function(xhr, status, error) {
                            ...
                            if (xhr.status == 422) {
                                ...
                                for (let i = 0; i < invoiceItemCount; i++) {
                                    ...
                                    errors[`user_invoice_items[${i}][vat_amount]`] = errors[
                                        `user_invoice_items.${i}.vat_amount`]?.[0];
                                    errors[`user_invoice_items[${i}][price_amount]`] = errors[
                                        `user_invoice_items.${i}.price_amount`]?.[0];
                                    errors[`user_invoice_items[${i}][total_amount]`] = errors[
                                        `user_invoice_items.${i}.total_amount`]?.[0];
                                    ...
                                    delete errors[`user_invoice_items.${i}.vat_amount`];
                                    delete errors[`user_invoice_items.${i}.price_amount`];
                                    delete errors[`user_invoice_items.${i}.total_amount`];
                                }
