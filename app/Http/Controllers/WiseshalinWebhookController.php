...
class WiseshalinWebhookController extends Controller
{
    public $service;
    ...
    public function receivedPaymentStore($invoice,$amount){
        ...
        $payment_source = PaymentSource::where('title','Wise')->where('workspace_id',2)->first();
        DB::beginTransaction();
        try{
            ...
            if (
                ...
                ($invoice->client->workspace->slug === 'shalin-designs')
            ) {
                try {
